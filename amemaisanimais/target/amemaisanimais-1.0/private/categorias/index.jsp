...
<% session.setAttribute("secAtual", "categorias");%>
<c:set var="titulo" scope="page" value="Categorias" />
    ...
    <body>
        ...
        <section class="proContainer">
            ...
            <section class="proWrapper">
                <a class="proButton no-rounded-border btn btn-primary btn-large" href="?acao=inserir"><i class="fa fa-plus"></i> Adicionar categoria</a>
                ...
                <div class="table-responsive proTable__container">
                    ...
                    <table class="proTable proTable--infinite-scroll table table-striped" id="tabCategorias" data-url="<%=App.BASE_URL%>/private/categorias/" data-scroll-page="2" <c:if test="${param.acao == 'filtrar'}">
                           ...
                           >
                            ...
                            <c:forEach items="${listaCategoria}" var="c">
                                <tr>
                                    <td class="text-center" data-toggle="modal" data-target="#modalExcluir" data-backdrop="static" data-row='{"acao": "excluir", "id": "${c.id}"}' data-description="Deseja realmente excluir a categoria ${c.id} - ${c.descricao}?">
                                    ...
                                    <td class="text-center">
                                        <a class="proTooltip proButton--link" data-toggle="tooltip" data-original-title="Alterar" href="?acao=alterar&id=${c.id}">
                                            <i class="fa fa-edit fa-lg"></i>
                                            <span class="visible-sm visible-xs">Alterar</span>
                                        </a>
                                    </td>

                                    <td class="proTable__nomeUsuario">${c.descricao}</td>
                                </tr>
                            </c:forEach>
                        </tbody> 
                    </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a class="no-rounded-border btn btn-default pull-left" href="<%=App.BASE_URL%>/private/categorias">Limpar Filtros</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="proButton proButton--confirm no-rounded-border btn btn-primary" data-url="<%=App.BASE_URL%>/private/categorias/" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Excluindo...">Excluir</button>
                    </div>
                </div>
            </div>
        </div>
