...
<html lang='pt-BR'>
    <head>
        ...
        <script src="../../js/proAme_Categoria.js" type="text/javascript"></script>
    </head>
    <body>

        <c:choose>
            <c:when test="${requestScope.acao == 'alterar'}">
                <c:set var="titulo" scope="page" value="Alterar Categoria" />
            </c:when>
            <c:otherwise>
                <c:set var="titulo" scope="page" value="Cadastrar Categoria" />
            </c:otherwise>
        </c:choose>
        ...
        <section class="proContainer">
            ...
            <div class="proWrapper">
                ...
                <c:set var="msg" value="${requestScope.formCategoria}" />
                <c:choose>
                        ...
                        <div class="modal fade" id="modalMensagem" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>Não foi possível ${msg} a categoria. Um log do erro será gerado!</p>
                                    </div>
